  ...
  return (
    <div className="footer">
      <div className="main_footer_div">
        <div className="footerContainer">
          <div className="footerLogo">
            ...
            <p >
              We are a Brand Identity Development Company that enjoys sharing
              the value of brands with clients All over the world.
            </p>
          </div>
          <div className="footerContact">
            ...
            <div className="contactList">
              <p>
                Phone: <a href="#">+1 878-219-4792</a>
              </p>
              <p>
                Email: <a href="#">info@usdesigncentral.com</a>
              </p>
            ...
            <ul>
              <li>
                <a className="social" href="#">
                  <BsFacebook size={30} className="iconF" />
                </a>
              </li>
              <li>
                <a className="social" href="#">
                  <BsYoutube size={30} className="iconY" />
                </a>
              </li>
              <li>
                <a className="social" href="#">
                  <BsLinkedin size={30} className="iconL" />
                </a>
              </li>
            </ul>
          </div>
      ...
      <p className="disclamer">
        <strong>Disclaimer:</strong> Your call will be recorded for quality
        assurance purpose.
      </p>
    </div>
  );
