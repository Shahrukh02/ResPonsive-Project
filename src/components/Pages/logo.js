    ...
    <div className="centerTwo">
        ...
        <div className="Imgcontainer">
          ...
          <div className="descript">
            <p>
              ...
              design gives a logo the depth that a 2D logo fails to give. 3D
              logo designs almost bring the logo to life giving it realistic
              lusters.
            </p>
          </div>
          <div className="btn">
            <a className="Imgbutn" href="#">
              Get Started
            </a>
          </div>
        </div>
        ...
        <div className="Imgcontainer">
          ...
          <div className="descript">
            <p>
              ...
              logo designs use bold typography to directly get the message
              across using the corporation or brand logo name.
            </p>
          </div>
          <div className="btn">
            <a className="Imgbutn" href="#">
      ...
      <div className="containerTwo">
        <div className="Imgcontainer">
          ...
          <div className="descript">
            <p>
              ...
              is somewhat similar to an icon logo in a way that it employs a
              graphic based design that is the noticeable or impactful.
            </p>
          </div>
          <div className="btn">
            <a className="Imgbutn" href="#">
        ...
        <div className="Imgcontainer">
          ...
          <div className="btn">
            <a className="Imgbutn">Get Started</a>
            {/* {showPopup && <PopupForm />} */}
            {/* onClick={togglePopup} */}
          </div>
        </div>
