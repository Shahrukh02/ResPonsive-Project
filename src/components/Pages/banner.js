    ...
    if (uName && uEmail && uPhone) {
      if (!validateEmail(uEmail)) {
        ...
        const res = await fetch(
          "https://logowebsite-90b5e-default-rtdb.asia-southeast1.firebasedatabase.app/logowebsiteform.json",
          {
            method: "POST",
            headers: {
  ...
  return (
    <div className="centerOne">
      <div className="heading1">
        ...
        <h2>
          Premuim Custom <span>Logo Design Service</span>
        </h2>
        <h2 className="heading2">In Just 24 Hours</h2>
        <p className="heading3">
          Get your custom logo designed by the most reliable Design Agency
        </p>
        <h2 className="heading4">
          SIGNUP NOW TO RESERVE<span> 70% DISCOUNT</span>
        </h2>
        <div className="rightB"></div>
      </div>
      <div className="main_form_container_div">
        <div className="formContainer">
          ...
          <form className="form">
            <button onClick={PostData} className="submitBtn" type="submit">
              SUBMIT
            </button>
          </form>
          </div>
      ...
      <div className="bannerImg5">
        <img src={BannerFive} className="logo_resize"/>
      </div>
